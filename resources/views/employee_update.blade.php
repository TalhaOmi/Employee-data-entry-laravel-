...
<div class="row">
        ...
        @endif
            <div class="card card-primary">
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="{{ url('update-employee')}}/{{$employee_info->id }}">
                  @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="acno" id="acno" placeholder="Enter A/C No."  value="{{ $employee_info->ac_no}}">
                  </div>
                  <div class="form-group">
